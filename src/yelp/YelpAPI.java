...
public class YelpAPI {
    ...
    private static final String CLIENT_ID = "o1MsdELGuXgp1ki4LcqtTw";
    private static final String CLIENT_SECRET = "MbxOmZmqbLIot4xA9CcZqdLlOULKBUxDtP9NgsigIPQs5JlZQ1KZXc9RlqatIsaa";
